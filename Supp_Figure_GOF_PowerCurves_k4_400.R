...
save(file="PCsk4n400.Rdata",
     pSks_C1_400, pWks_C1_400, pBon_C1_400,
     pSks_C3_400, pWks_C3_400, pBon_C3_400)

#pdf("Supp_Figure_GOF_PowerCurves_k4_400.pdf", width=19.5, heigh=13)

png("Supp_Figure_GOF_PowerCurves_k4_400.pdf", width=1872, heigh=1248)
